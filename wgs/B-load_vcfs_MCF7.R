...
## Options
data_dir = "/rds/general/user/hdhiman/ephemeral/reWGS_MCF7/results/all/vep"
out_dat_dir = "/rds/general/user/hdhiman/ephemeral/reWGS_MCF7/results/all/vcf_data"
reference_sample = c("POT_1_new", "POT_2_new", "POT_3_new")
vcf_suffix = "[.]vcf([.]gz)?$"
